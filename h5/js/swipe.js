...
Swipe.prototype = {
  ...
  slide: function(index, duration, turnpage) {
	...
	// if the swipe doesn't prompt a page change, the it shouldn't prompt changepage and playslide
  ...
  fingermoving==0;
    ...
    if (!this.isScrolling) {
      ...
      // call slide function with slide end value based on isValidSlide and isPastBounds tests
		this.slide( this.index + ( isValidSlide && !isPastBounds ? (this.deltaX < 0 ? 1 : -1) : 0 ), this.speed, ( isValidSlide && !isPastBounds ? (this.deltaX < 0 ? 1 : -1) : 0 ));
    }
